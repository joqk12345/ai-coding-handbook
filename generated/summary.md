...
> Auto-generated from `SUMMARY.md` section structure and reading order.
...
## 可视化总览
- [时间线](/visualizations/timeline-overview)
- [架构图](/visualizations/architecture-overview)
...
- [第4章：Coding Agents 如何重塑工程、产品与设计（EPD）](/part-1/chapter-4-coding-agents-reshaping-epd)
    - [4.1（第1部分延伸）: AI 优先的软件开发时代](/part-1/chapter-4-ai-first-software-development)
    - [4.2（第1部分延伸）: 对 AI 的认识与智能体（AI Agent）的演进方向](/part-1/chapter-4-2-ai-cognition-and-agent-evolution)

## 第二部分：核心工具详解 (第5-9章)
- [第5章: Claude 使用手册](/part-2/chapter-4-claude-manual)
    - [5.1: Claude Code 深度解析](/part-2/chapter-4-1-claude-code-architecture)
    - [5.2: Advent of Claude - 31天精通 Claude Code](/part-2/chapter-4-2-advent-of-claude)
    ...
    - [5.5: Claude Code Showcase 配置拆解](/part-2/chapter-4-5-claude-code-showcase)
    - [5.6: 实战中上下文的管理与添加](/part-2/chapter-4-6-context-management)
    - [5.7: Claude Code 高级功能与使用技巧](/part-2/chapter-4-7-advanced-features)
...
- [第6章: OpenAI Codex 深度解析](/part-2/chapter-5-codex-deep-dive)
    ...
    - [6.3: Claude Code vs Codex: 权威对比指南](/part-2/chapter-5-3-claude-code-vs-codex)
...
- [第12章: 综合项目实战](/part-3/chapter-11-capstone)
    - [12.1: 构建终端原生 AI 编码智能体：脚手架、运行框架（Harness）、上下文工程与经验教训](/part-3/chapter-12-1-terminal-ai-coding-agents)
    - [12.2: OpenDev 架构总览：分层体系、智能体核心与运行时机制](/part-3/chapter-12-2-opendev-architecture)
    - [12.3: OpenDev 的上下文工程层：提示词、记忆、压缩与检索组装](/part-3/chapter-12-3-context-engineering-layer)
    - [12.4: OpenDev 的工具系统：注册表架构、文件操作与可扩展能力](/part-3/chapter-12-4-tool-system)
    - [12.5: OpenDev 的持久化层：会话、撤销、配置与模型缓存系统](/part-3/chapter-12-5-persistence-layer)
    - [12.6: OpenDev 的五个核心设计张力与可迁移经验](/part-3/chapter-12-6-design-tensions-lessons)

## 第四部分：实践 - 从零构建 Agent (第13-19章)
- [第13章: 从零构建 AI Agent](/part-4/chapter-12-building-agent)
- [第14章: 高级 Agent 模式](/part-4/chapter-13-advanced-patterns)
- [第15章: 多智能体系统](/part-4/chapter-14-multi-agent)
...
## 第五部分：自主代码库 (第19-30章)
- [第19章: 自主代码库 - 背景智能体与软件交付的下一个时代](/part-5/chapter-18-self-driving-codebase)
