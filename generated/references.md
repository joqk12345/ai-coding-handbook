...
> Auto-generated external reference index grouped by source domain.

## adocomplete.com

| 参考链接 | 被引用章节 | 次数 |
| --- | --- | --- |
| [adocomplete.com/advent-of-claude-2025](https://adocomplete.com/advent-of-claude-2025/) | [5.2: Advent of Claude - 31天精通 Claude Code](/part-2/chapter-4-2-advent-of-claude)<br>[第18章: 从怀疑者到信徒 —— 一位AI编码怀疑论者的深度实践](/part-4/chapter-17-skeptic-believer) | 2 |

## agents.md

| 参考链接 | 被引用章节 | 次数 |
| --- | --- | --- |
| [agents.md](https://agents.md/) | [第3章: Agent 本质](/part-1/chapter-3-agent-nature) | 1 |
...
| 参考链接 | 被引用章节 | 次数 |
| --- | --- | --- |
| [gist.github.com/gwern](https://gist.github.com/gwern/) | [第18章: 从怀疑者到信徒 —— 一位AI编码怀疑论者的深度实践](/part-4/chapter-17-skeptic-believer) | 1 |

## github.com

| 参考链接 | 被引用章节 | 次数 |
| --- | --- | --- |
| [github.com/anthropics/skills/tree/main/skills](https://github.com/anthropics/skills/tree/main/skills) | [5.3: Agent Skills（智能体技能）入门](/part-2/chapter-4-3-agent-skills)<br>[附录B: 推荐资源与社区](/appendix/appendix-b-resources) | 2 |
| [github.com/ChrisWiles/claude-code-showcase](https://github.com/ChrisWiles/claude-code-showcase) | [5.5: Claude Code Showcase 配置拆解](/part-2/chapter-4-5-claude-code-showcase)<br>[附录B: 推荐资源与社区](/appendix/appendix-b-resources) | 2 |
| [github.com/ChrisWiles/claude-code-showcase/...](https://github.com/ChrisWiles/claude-code-showcase/tree/main/.claude) | [5.5: Claude Code Showcase 配置拆解](/part-2/chapter-4-5-claude-code-showcase)<br>[附录B: 推荐资源与社区](/appendix/appendix-b-resources) | 2 |
| [github.com/heilcheng/awesome-agent-skills/t...](https://github.com/heilcheng/awesome-agent-skills/tree/main) | [5.3: Agent Skills（智能体技能）入门](/part-2/chapter-4-3-agent-skills)<br>[附录B: 推荐资源与社区](/appendix/appendix-b-resources) | 2 |
| [github.com/agiresearch/AIOS](https://github.com/agiresearch/AIOS) | [第22章: 上下文工程的文件系统抽象 — AIGNE 框架](/part-5/chapter-21-context-engineering) | 1 |
| [github.com/aigne](https://github.com/aigne) | [第22章: 上下文工程的文件系统抽象 — AIGNE 框架](/part-5/chapter-21-context-engineering) | 1 |
| [github.com/ChrisWiles/claude-code-showcase/...](https://github.com/ChrisWiles/claude-code-showcase/blob/main/README.md) | [5.5: Claude Code Showcase 配置拆解](/part-2/chapter-4-5-claude-code-showcase) | 1 |
...
| [github.com/runesleo/claude-code-workflow.git](https://github.com/runesleo/claude-code-workflow.git) | [第16章: Claude Code Workflow —— 经过实战检验的 Agent 工作流模板](/part-4/chapter-15-claude-workflow) | 1 |
...
| 参考链接 | 被引用章节 | 次数 |
| --- | --- | --- |
| [pencil.dev](https://pencil.dev) | [第23章: 周末氛围直播复盘——AI Coding 的十倍加速时代](/part-5/chapter-23-vibed-coding-indigo) | 1 |
...
| 参考链接 | 被引用章节 | 次数 |
| --- | --- | --- |
| [support.claude.com/en/articles/12512198-how-to-crea...](https://support.claude.com/en/articles/12512198-how-to-create-custom-skills) | [5.3: Agent Skills（智能体技能）入门](/part-2/chapter-4-3-agent-skills)<br>[附录B: 推荐资源与社区](/appendix/appendix-b-resources) | 2 |
