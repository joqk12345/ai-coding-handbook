...
*   **第二部分：核心工具详解 (第5-9章)**
    ...
    *   [5.1: Claude Code 深度解析](part-2/chapter-4-1-claude-code-architecture.md)
    *   [5.2: Advent of Claude - 31天精通 Claude Code](part-2/chapter-4-2-advent-of-claude.md)
    *   [5.3: Agent Skills（智能体技能）入门](part-2/chapter-4-3-agent-skills.md)
    *   [5.4: Claude Code 创造者如何使用 Claude Code](part-2/chapter-4-4-how-creator-uses-claude-code.md)
    *   [5.5: Claude Code Showcase 配置拆解](part-2/chapter-4-5-claude-code-showcase.md)
    *   [5.6: 实战中上下文的管理与添加](part-2/chapter-4-6-context-management.md)
    *   [5.7: Claude Code 高级功能与使用技巧](part-2/chapter-4-7-advanced-features.md)
    *   [5.8: 对话管理与上下文控制](part-2/chapter-4-8-conversation-management.md)
    *   [5.9: 创建自定义命令](part-2/chapter-4-9-custom-commands.md)
    *   [5.10: MCP 服务器扩展](part-2/chapter-4-10-mcp-servers.md)
    *   [5.11: GitHub 集成](part-2/chapter-4-11-github-integration.md)
    *   [5.12: Lessons from Building Claude Code - Prompt 缓存即一切](part-2/chapter-4-12-prompt-caching.md)
    *   [5.13: Lessons from Building Claude Code - 像 Agent 一样思考](part-2/chapter-4-13-agent-tool-design.md)
    *   [5.14: Git Worktree 模式与 Agent 工具设计艺术](part-2/chapter-4-14-git-worktree-mode.md)
...
*   **第三部分：高级技巧与实战 (第10-12章)**
    *   [第10章: Prompt Engineering for Coders](part-3/chapter-9-prompt-engineering.md)
    *   [第11章: AI驱动的测试与调试](part-3/chapter-10-ai-testing.md)
    *   [第12章: 综合项目实战](part-3/chapter-11-capstone.md)

    *   [12.1: 构建终端原生 AI 编码智能体：脚手架、运行框架（Harness）、上下文工程与经验教训](part-3/chapter-12-1-terminal-ai-coding-agents.md)
    *   [12.2: OpenDev 架构总览：分层体系、智能体核心与运行时机制](part-3/chapter-12-2-opendev-architecture.md)
    *   [12.3: OpenDev 的上下文工程层：提示词、记忆、压缩与检索组装](part-3/chapter-12-3-context-engineering-layer.md)
    *   [12.4: OpenDev 的工具系统：注册表架构、文件操作与可扩展能力](part-3/chapter-12-4-tool-system.md)
    *   [12.5: OpenDev 的持久化层：会话、撤销、配置与模型缓存系统](part-3/chapter-12-5-persistence-layer.md)
    *   [12.6: OpenDev 的五个核心设计张力与可迁移经验](part-3/chapter-12-6-design-tensions-lessons.md)
*   **第四部分：实践 - 从零构建 Agent (第13-19章)**
    *   [第13章: 从零构建 AI Agent](part-4/chapter-12-building-agent.md)
    *   [第14章: 高级 Agent 模式](part-4/chapter-13-advanced-patterns.md)
    *   [第15章: 多智能体系统](part-4/chapter-14-multi-agent.md)
    *   [第16章: Claude Code Workflow —— 经过实战检验的 Agent 工作流模板](part-4/chapter-15-claude-workflow.md)
    *   [第17章: Trellis —— 为 AI 设置规则的开放框架](part-4/chapter-16-trellis.md)
...
*   **第五部分：自主代码库 (第19-30章)**
    ...
    *   [第27章: Harness Engineering 框架——从漂移的 Agent 到复合的系统](part-5/chapter-27-harness-engineering-framework.md)
        ...
        *   [27.3: How Coding Agents Work：LLM、系统提示与工具循环](part-5/chapter-27-3-how-coding-agents-work.md)
    ...
    *   [第30章: AgentOS——从应用孤岛到自然语言驱动的数据生态](part-5/chapter-29-agentos-from-silos-to-nui.md)
