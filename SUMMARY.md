...
*   **第二部分：核心工具详解**
    ...
    *   [2.1: Claude Code 深度解析](part-2-core-tools/chapter-2-1-claude-code-architecture.md)
    *   [2.2: Advent of Claude - 31天精通 Claude Code](part-2-core-tools/chapter-2-2-advent-of-claude.md)
    *   [2.3: Agent Skills（智能体技能）入门](part-2-core-tools/chapter-2-3-agent-skills.md)
    *   [2.4: Claude Code 创造者如何使用 Claude Code](part-2-core-tools/chapter-2-4-how-creator-uses-claude-code.md)
...
*   **第三部分：高级技巧与实战**
    *   [第7章: Prompt Engineering for Coders](part-3-advanced-techniques/chapter-7-prompt-engineering-for-coders.md)
    *   [第8章: AI驱动的测试与调试](part-3-advanced-techniques/chapter-8-ai-driven-testing.md)
    *   [第9章: 综合项目实战](part-3-advanced-techniques/chapter-9-capstone-project.md)

*   **第四部分：实践 - 从零构建 Agent**
    *   [第10章: 从零构建 AI Agent](part-4-practice/chapter-10-building-agent-from-scratch.md)
    *   [第11章: 高级 Agent 模式](part-4-practice/chapter-11-advanced-agent-patterns.md)
...
*   **第五部分：自主代码库**
    *   [第14章: 自主代码库 - 背景智能体与软件交付的下一个时代](part-5-self-driving-codebase/chapter-13-the-self-driving-codebase.md)
